...
public class PlanillasDTO {
	...
	//@OneToMany(mappedBy = "DetallePlanillaDTO", cascade = CascadeType.ALL, orphanRemoval = true)
	private List<DetallePlanillaDTO> asistentes = new ArrayList<DetallePlanillaDTO>();
...
public List<DetallePlanillaDTO> getAsistentes() {
	return asistentes;
}


public void setAsistentes(List<DetallePlanillaDTO> asistentes) {
